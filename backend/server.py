    ...
    try:
        ...
        if error:
            ...
            return RedirectResponse(
                url=f'https://18de7278-a979-4e48-8ae0-085f7bf93526.preview.emergentagent.com/?auth=error&message={error}&session_id={session_id}',
                status_code=302
            )
        ...
        if not code:
            ...
            return RedirectResponse(
                url=f'https://18de7278-a979-4e48-8ae0-085f7bf93526.preview.emergentagent.com/?auth=error&message=no_code&session_id={session_id}',
                status_code=302
            )

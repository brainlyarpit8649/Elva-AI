    ...
    try:
        ...
        if error:
            ...
            return RedirectResponse(
                url=f'https://63358e7a-1206-4b51-81b2-53acaaaf0a84.preview.emergentagent.com/?auth=error&message={error}&session_id={session_id}',
                status_code=302
            )
        ...
        if not code:
            ...
            return RedirectResponse(
                url=f'https://63358e7a-1206-4b51-81b2-53acaaaf0a84.preview.emergentagent.com/?auth=error&message=no_code&session_id={session_id}',
                status_code=302
            )
        ...
        if result.get("authenticated", False):
            ...
            return RedirectResponse(
                url=f'https://63358e7a-1206-4b51-81b2-53acaaaf0a84.preview.emergentagent.com/?auth=success&service=gmail&session_id={session_id}',
                status_code=302
            )
        else:
            ...
            return RedirectResponse(
                url=f'https://63358e7a-1206-4b51-81b2-53acaaaf0a84.preview.emergentagent.com/?auth=error&message=auth_failed&details={error_msg}&session_id={session_id}',
                status_code=302
            )
        ...
        # Redirect to frontend with error parameter
        return RedirectResponse(
            url=f'https://63358e7a-1206-4b51-81b2-53acaaaf0a84.preview.emergentagent.com/?auth=error&message=server_error&details={str(e)}&session_id={session_id if session_id else "unknown"}',
            status_code=302
        )

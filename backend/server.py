    ...
    try:
        ...
        if error:
            ...
            return RedirectResponse(
                url=f'https://d62b4a87-6fa2-4774-94f5-8b98144d123f.preview.emergentagent.com/?auth=error&message={error}&session_id={session_id}',
                status_code=302
            )
        ...
        if not code:
            ...
            return RedirectResponse(
                url=f'https://d62b4a87-6fa2-4774-94f5-8b98144d123f.preview.emergentagent.com/?auth=error&message=no_code&session_id={session_id}',
                status_code=302
            )

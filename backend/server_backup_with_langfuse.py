    ...
    try:
        ...
        if error:
            ...
            return RedirectResponse(
                url=f'https://a4ed5dbc-714c-4144-beb6-635470d8f0fb.preview.emergentagent.com/?auth=error&message={error}&session_id={session_id}',
                status_code=302
            )
        ...
        if not code:
            ...
            return RedirectResponse(
                url=f'https://a4ed5dbc-714c-4144-beb6-635470d8f0fb.preview.emergentagent.com/?auth=error&message=no_code&session_id={session_id}',
                status_code=302
            )
        ...
        if result.get("authenticated", False):
            ...
            return RedirectResponse(
                url=f'https://a4ed5dbc-714c-4144-beb6-635470d8f0fb.preview.emergentagent.com/?auth=success&service=gmail&session_id={session_id}&timestamp={int(datetime.utcnow().timestamp())}',
                status_code=302
            )
        else:
            ...
            return RedirectResponse(
                url=f'https://a4ed5dbc-714c-4144-beb6-635470d8f0fb.preview.emergentagent.com/?auth=error&message=auth_failed&details={error_msg}&session_id={session_id}',
                status_code=302
            )
        ...
        # Redirect to frontend with error parameter
        return RedirectResponse(
            url=f'https://a4ed5dbc-714c-4144-beb6-635470d8f0fb.preview.emergentagent.com/?auth=error&message=server_error&details={str(e)}&session_id={session_id if session_id else "unknown"}',
            status_code=302
        )

        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://f2fd78a1-eaf2-41b5-9b43-56eeb38394ae.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://f2fd78a1-eaf2-41b5-9b43-56eeb38394ae.preview.emergentagent.com/api/gmail/callback"

        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://969852c2-df19-4799-8b24-72ad4de8f1d2.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://969852c2-df19-4799-8b24-72ad4de8f1d2.preview.emergentagent.com/api/gmail/callback"

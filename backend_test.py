...
BACKEND_URL = "https://d62b4a87-6fa2-4774-94f5-8b98144d123f.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://d62b4a87-6fa2-4774-94f5-8b98144d123f.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://d62b4a87-6fa2-4774-94f5-8b98144d123f.preview.emergentagent.com/api/gmail/callback"

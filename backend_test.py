...
BACKEND_URL = "https://ed7c75c6-52d3-43f9-ad73-470fe4e4db6e.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://ed7c75c6-52d3-43f9-ad73-470fe4e4db6e.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://ed7c75c6-52d3-43f9-ad73-470fe4e4db6e.preview.emergentagent.com/api/gmail/callback"

...
BACKEND_URL = "https://3abf5a61-6358-4939-8ff5-a5bb373f6612.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get("success") and data.get("auth_url"):
                    ...
                    # Check redirect URI
                    expected_redirect = "https://3abf5a61-6358-4939-8ff5-a5bb373f6612.preview.emergentagent.com/api/gmail/callback"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://3abf5a61-6358-4939-8ff5-a5bb373f6612.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://3abf5a61-6358-4939-8ff5-a5bb373f6612.preview.emergentagent.com/api/gmail/callback"

...
BACKEND_URL = "https://72e97293-ded7-4170-aeb3-7df6343cbbb4.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://72e97293-ded7-4170-aeb3-7df6343cbbb4.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://72e97293-ded7-4170-aeb3-7df6343cbbb4.preview.emergentagent.com/api/gmail/callback"

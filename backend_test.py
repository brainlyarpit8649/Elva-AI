...
BACKEND_URL = "https://45c01f6d-38f0-48e1-895f-afda66949498.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://45c01f6d-38f0-48e1-895f-afda66949498.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://45c01f6d-38f0-48e1-895f-afda66949498.preview.emergentagent.com/api/gmail/callback"

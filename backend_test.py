...
BACKEND_URL = "https://784f5565-bee2-4e24-a506-215223028ef2.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://784f5565-bee2-4e24-a506-215223028ef2.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://784f5565-bee2-4e24-a506-215223028ef2.preview.emergentagent.com/api/gmail/callback"

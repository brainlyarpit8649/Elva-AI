...
BACKEND_URL = "https://7409d80e-874f-46ba-a365-d3d23c377dd3.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://7409d80e-874f-46ba-a365-d3d23c377dd3.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://7409d80e-874f-46ba-a365-d3d23c377dd3.preview.emergentagent.com/api/gmail/callback"

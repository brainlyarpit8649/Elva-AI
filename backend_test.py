        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get("success") and data.get("auth_url"):
                    ...
                    # Check redirect URI
                    expected_redirect = "https://036e8f47-2d63-48b2-8d92-5307403f57fb.preview.emergentagent.com/api/gmail/callback"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://036e8f47-2d63-48b2-8d92-5307403f57fb.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://036e8f47-2d63-48b2-8d92-5307403f57fb.preview.emergentagent.com/api/gmail/callback"

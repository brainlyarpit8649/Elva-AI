...
BACKEND_URL = "https://dea14af1-4b20-4ff1-b1a9-c8e47f0c2a45.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://dea14af1-4b20-4ff1-b1a9-c8e47f0c2a45.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://dea14af1-4b20-4ff1-b1a9-c8e47f0c2a45.preview.emergentagent.com/api/gmail/callback"

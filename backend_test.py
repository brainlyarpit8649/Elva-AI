...
BACKEND_URL = "https://890f01c8-e08b-4ca4-b2c7-c59c6a30d7ac.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://890f01c8-e08b-4ca4-b2c7-c59c6a30d7ac.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://890f01c8-e08b-4ca4-b2c7-c59c6a30d7ac.preview.emergentagent.com/api/gmail/callback"

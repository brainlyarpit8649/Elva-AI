...
BACKEND_URL = "https://39b88d68-c638-4cd8-9443-55f17f6aea28.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://39b88d68-c638-4cd8-9443-55f17f6aea28.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://39b88d68-c638-4cd8-9443-55f17f6aea28.preview.emergentagent.com/api/gmail/callback"

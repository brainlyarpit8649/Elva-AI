...
BACKEND_URL = "https://1a7f264a-155b-4a63-9088-2d8c37076fb0.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://1a7f264a-155b-4a63-9088-2d8c37076fb0.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://1a7f264a-155b-4a63-9088-2d8c37076fb0.preview.emergentagent.com/api/gmail/callback"

...
BACKEND_URL = "https://fad2f03c-1b97-4c05-8c0d-579a764ed85c.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://fad2f03c-1b97-4c05-8c0d-579a764ed85c.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://fad2f03c-1b97-4c05-8c0d-579a764ed85c.preview.emergentagent.com/api/gmail/callback"

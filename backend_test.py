...
BACKEND_URL = "https://3f972ebc-340d-4044-8347-235179bd9a5e.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get("success") and data.get("auth_url"):
                    ...
                    # Check redirect URI
                    expected_redirect = "https://3f972ebc-340d-4044-8347-235179bd9a5e.preview.emergentagent.com/api/gmail/callback"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://3f972ebc-340d-4044-8347-235179bd9a5e.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://3f972ebc-340d-4044-8347-235179bd9a5e.preview.emergentagent.com/api/gmail/callback"

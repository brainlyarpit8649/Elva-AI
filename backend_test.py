        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://603a1fa3-b3e5-4d58-b2f2-589bb867edd6.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://603a1fa3-b3e5-4d58-b2f2-589bb867edd6.preview.emergentagent.com/api/gmail/callback"

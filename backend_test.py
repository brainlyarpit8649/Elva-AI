        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get("success") and data.get("auth_url"):
                    ...
                    # Check redirect URI
                    expected_redirect = "https://d10e365f-da53-4afb-9ff3-dab3e0d6bd7e.preview.emergentagent.com/api/gmail/callback"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://d10e365f-da53-4afb-9ff3-dab3e0d6bd7e.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://d10e365f-da53-4afb-9ff3-dab3e0d6bd7e.preview.emergentagent.com/api/gmail/callback"

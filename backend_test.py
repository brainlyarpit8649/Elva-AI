...
BACKEND_URL = "https://e69ec2a0-4e99-4661-87bb-b4d32bdcd804.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://e69ec2a0-4e99-4661-87bb-b4d32bdcd804.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://e69ec2a0-4e99-4661-87bb-b4d32bdcd804.preview.emergentagent.com/api/gmail/callback"

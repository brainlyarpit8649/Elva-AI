...
BACKEND_URL = "https://c94530e9-47cf-406f-9cd7-4ef31941e126.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://c94530e9-47cf-406f-9cd7-4ef31941e126.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://c94530e9-47cf-406f-9cd7-4ef31941e126.preview.emergentagent.com/api/gmail/callback"

...
BACKEND_URL = "https://682dd8cc-6ce4-48cb-bb8d-86737ebce0c9.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://682dd8cc-6ce4-48cb-bb8d-86737ebce0c9.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://682dd8cc-6ce4-48cb-bb8d-86737ebce0c9.preview.emergentagent.com/api/gmail/callback"

...
BACKEND_URL = "https://1ab9abda-2e09-4ee4-938d-5e66a04385d9.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://1ab9abda-2e09-4ee4-938d-5e66a04385d9.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://1ab9abda-2e09-4ee4-938d-5e66a04385d9.preview.emergentagent.com/api/gmail/callback"

...
BACKEND_URL = "https://67d702ac-e945-429b-ad8d-9ad023dfb124.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://67d702ac-e945-429b-ad8d-9ad023dfb124.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://67d702ac-e945-429b-ad8d-9ad023dfb124.preview.emergentagent.com/api/gmail/callback"

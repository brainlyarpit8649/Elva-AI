...
BACKEND_URL = "https://b9bc1167-8c84-4952-8ff7-d2758b98eea1.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://b9bc1167-8c84-4952-8ff7-d2758b98eea1.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://b9bc1167-8c84-4952-8ff7-d2758b98eea1.preview.emergentagent.com/api/gmail/callback"

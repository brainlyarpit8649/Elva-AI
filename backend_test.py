...
BACKEND_URL = "https://2c9e3233-f27a-4ffd-bb9e-425436227b20.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://2c9e3233-f27a-4ffd-bb9e-425436227b20.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://2c9e3233-f27a-4ffd-bb9e-425436227b20.preview.emergentagent.com/api/gmail/callback"

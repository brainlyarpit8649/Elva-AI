...
BACKEND_URL = "https://63358e7a-1206-4b51-81b2-53acaaaf0a84.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://63358e7a-1206-4b51-81b2-53acaaaf0a84.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://63358e7a-1206-4b51-81b2-53acaaaf0a84.preview.emergentagent.com/api/gmail/callback"

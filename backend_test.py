...
BACKEND_URL = "https://ed8496b4-5695-4758-b114-60d76b6cfc3b.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get("success") and data.get("auth_url"):
                    ...
                    # Check redirect URI
                    expected_redirect = "https://ed8496b4-5695-4758-b114-60d76b6cfc3b.preview.emergentagent.com/api/gmail/callback"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://ed8496b4-5695-4758-b114-60d76b6cfc3b.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://ed8496b4-5695-4758-b114-60d76b6cfc3b.preview.emergentagent.com/api/gmail/callback"

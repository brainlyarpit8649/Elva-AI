...
BACKEND_URL = "https://e6e527f6-9110-4ca4-bcbc-e7c575b313b4.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://e6e527f6-9110-4ca4-bcbc-e7c575b313b4.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://e6e527f6-9110-4ca4-bcbc-e7c575b313b4.preview.emergentagent.com/api/gmail/callback"

...
BACKEND_URL = "https://49680d49-ff21-4e34-a21c-a517c5424973.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://49680d49-ff21-4e34-a21c-a517c5424973.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://49680d49-ff21-4e34-a21c-a517c5424973.preview.emergentagent.com/api/gmail/callback"

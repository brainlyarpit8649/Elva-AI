        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://84626dc5-5ece-4e7b-a44b-90230e6a6f03.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://84626dc5-5ece-4e7b-a44b-90230e6a6f03.preview.emergentagent.com/api/gmail/callback"

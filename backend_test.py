...
BACKEND_URL = "https://762b6646-df15-47e0-82e3-b4c2997b2011.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://762b6646-df15-47e0-82e3-b4c2997b2011.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://762b6646-df15-47e0-82e3-b4c2997b2011.preview.emergentagent.com/api/gmail/callback"

        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://7234ba76-190b-4a40-aa0d-dac5cf468217.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://7234ba76-190b-4a40-aa0d-dac5cf468217.preview.emergentagent.com/api/gmail/callback"

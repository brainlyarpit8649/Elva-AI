...
BACKEND_URL = "https://aac17c76-bf24-4440-9340-97ce1bd35c08.preview.emergentagent.com/api"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_components = [
                    ...
                    "redirect_uri=https://aac17c76-bf24-4440-9340-97ce1bd35c08.preview.emergentagent.com/api/gmail/callback",
                    "scope=",
                    "response_type=code"
                ]
    ...
    def test_gmail_service_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_redirect_uri = "https://aac17c76-bf24-4440-9340-97ce1bd35c08.preview.emergentagent.com/api/gmail/callback"

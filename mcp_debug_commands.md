...
```bash
curl -X GET "https://036e8f47-2d63-48b2-8d92-5307403f57fb.preview.emergentagent.com/api/admin/debug/context?session_id=YOUR_SESSION_ID&command=show_context" \

...
```bash
curl -X GET "https://0b30aab1-896e-477e-822b-002edcbac2b3.preview.emergentagent.com/api/admin/debug/context?session_id=YOUR_SESSION_ID&command=show_context" \

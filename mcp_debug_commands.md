...
```bash
curl -X GET "https://ee5e777b-dc22-480e-8057-5ec09c03a73c.preview.emergentagent.com/api/admin/debug/context?session_id=YOUR_SESSION_ID&command=show_context" \

...
```bash
curl -X GET "https://969852c2-df19-4799-8b24-72ad4de8f1d2.preview.emergentagent.com/api/admin/debug/context?session_id=YOUR_SESSION_ID&command=show_context" \

...
```bash
curl -X GET "https://a306185b-5af9-42eb-b13a-8333a56f33fb.preview.emergentagent.com/api/admin/debug/context?session_id=YOUR_SESSION_ID&command=show_context" \

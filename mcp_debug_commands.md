...
```bash
curl -X GET "https://d16fdba0-1be5-48f0-85b7-104cf45d55df.preview.emergentagent.com/api/admin/debug/context?session_id=YOUR_SESSION_ID&command=show_context" \

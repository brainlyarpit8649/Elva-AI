...
```bash
curl -X GET "https://c20efb94-1a9f-42d9-a126-b5157ee976a4.preview.emergentagent.com/api/admin/debug/context?session_id=YOUR_SESSION_ID&command=show_context" \

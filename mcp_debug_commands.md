...
```bash
curl -X GET "https://cc799cab-c063-4eaa-9ecb-266407734835.preview.emergentagent.com/api/admin/debug/context?session_id=YOUR_SESSION_ID&command=show_context" \

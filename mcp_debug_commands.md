...
```bash
curl -X GET "https://5be6aaaa-6734-49b7-bbc3-94369bffa03f.preview.emergentagent.com/api/admin/debug/context?session_id=YOUR_SESSION_ID&command=show_context" \

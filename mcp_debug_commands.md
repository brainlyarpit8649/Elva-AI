...
```bash
curl -X GET "https://5ecfe916-5a97-473e-93a6-1974a04632ff.preview.emergentagent.com/api/admin/debug/context?session_id=YOUR_SESSION_ID&command=show_context" \
